...
module Kamigo
  module Connections
    ...
    Definition = Data.define(:platform, :connection, :identity_scope, :adapter) do
      def initialize(platform:, connection:, identity_scope:, adapter:)
        values = [platform, connection, identity_scope]
        ...
        super(platform: platform.to_s.freeze, connection: connection.to_s.freeze,
          identity_scope: identity_scope.to_s.freeze, adapter: adapter)
      end
    end
